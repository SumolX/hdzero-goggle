...
int main(int argc, char **argv) {
    ...
    *env << "\t(LIVE555 Streaming Media version " << LIVEMEDIA_LIBRARY_VERSION_STRING << ")\n";
    ...
    if (createHandlerServerForREGISTERCommand) {
        ...
        handlerServerForREGISTERCommand = HandlerServerForREGISTERCommand::createNew(*env, continueAfterClientCreation0,
    ...
    do {
        ...
        *env << *rtspClient << "Set up the \"" << *subsession << "\" subsession\n";
        ...
        if (strcmp(subsession->mediumName(), "video") == 0) {
            ...
            ADTSAudioStreamDiscreteFramer *framer = ADTSAudioStreamDiscreteFramer::createNew(*env, subsession->readSource(),
