...
class HLSSegmenterMP4 : public MediaSink {
  ...
  private:
    HLSSegmenterMP4(UsageEnvironment &env, unsigned segmentationDuration, char const *fileNamePrefix,
                    onEndOfSegmentFunc *onEndOfSegmentFunc, void *onEndOfSegmentClientData);
    // called only by createNew()
    virtual ~HLSSegmenterMP4();
